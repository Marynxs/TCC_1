...
os mesmos valores serão mantidos fixos em todas as quatro
configurações experimentais. Essa decisão é essencial para
garantir que as diferenças de desempenho observadas entre as
configurações sejam atribuíveis exclusivamente às estratégias
avaliadas --- tipo de imagem e uso de aumento de dados ---
e não a variações no processo de otimização \cite{Dobrzycki2025}.
